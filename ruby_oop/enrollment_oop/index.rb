...
# 4. SubjectStudents => attributes: subject_id, student_id, teacher_id, day
# 5. Display the list of students, teachers and subjects
# 6. Allow the user to create SubjectStudents by choosing the following students, teachers and subjects
